...
WebUI.setText(findTestObject('Object Repository/Page_Login/input__EmailAddress'), GlobalVariable.B2BUSERNAME)

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Login/input__Password'), GlobalVariable.B2BPASSWORD)
